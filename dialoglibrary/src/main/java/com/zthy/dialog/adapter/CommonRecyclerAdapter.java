...
public abstract class CommonRecyclerAdapter<T> extends RecyclerView.Adapter<ViewHolder> {
     ...
     * 给条目设置点击和长按事件
     *********************/
    public OnItemCommonClickListener mItemClickListener;
    public OnLongCommonClickListener mLongClickListener;

    public void setOnItemClickListener(OnItemCommonClickListener itemClickListener) {
        this.mItemClickListener = itemClickListener;
    }

    public void setOnLongClickListener(OnLongCommonClickListener longClickListener) {
